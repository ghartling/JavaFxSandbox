...
@JsonPropertyOrder({ "stationId", "icaoId", "occurDate", "tmax", "tmin", "prcp", "snow", "snwd", "wsf2", "wsf5", "normalMonth", "normalDay", "normalFlag", "normalMax", "normalMin", "normalPrec",
		"stationDetail" })
public class GhcndDailyNormalDetail {
